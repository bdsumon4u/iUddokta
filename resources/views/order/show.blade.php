                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="clearfix row box-wrapper address">
                                            ...
                                            <div class="col-md-12">
                                                <div
                                                    class="form-group {{ $errors->has('customer_phone') ? 'has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <div
                                                    class="form-group {{ $errors->has('customer_address') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="" class="form-control"
                                                        id="current-price" value="{{ $cp }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    class="form-group {{ $errors->has('buy_price') ? 'has-error' : '' }}">
                                                    <label for="buy-price">
                                                        Buy<span>*</span>
                                                    </label>

                                                    <input type="text" name="buy_price"
                                                        wire:model.live.debounce.250ms="buy_price" wire:change="changed"
                                                        class="form-control" id="buy-price"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('sell') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="sell"
                                                        wire:model.live.debounce.250ms="sell" class="form-control"
                                                        id="sell-price" value="{{ old('sell', $sell) }}"
                                                        {{ $a_only }}>
                                            ...
                                            @if (!$is_reseller || ($is_reseller && ($order->status == 'DELIVERED') | ($order->status == 'FAILED')))
                                                ...
                                                <div class="col-md-4">
                                                    <div
                                                        class="form-group {{ $errors->has('packaging') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div
                                                        class="form-group {{ $errors->has('delivery_charge') ? 'has-error' : '' }}">
                                                        <label for="delivery-charge">
                                                            Delivery Charge
                                                        </label>

                                                        <input type="text" name="delivery_charge"
                                                            wire:model.live.debounce.250ms="delivery_charge"
                                                            wire:change="changed" class="form-control"
                                                            id="delivery-charge"
                                                ...
                                                <div class="col-md-4">
                                                    <div
                                                        class="form-group {{ $errors->has('cod_charge') ? 'has-error' : '' }}">
                                                        <label for="cod-charge">
                                                            COD / Return
                                                        </label>

                                                        <input type="text" name="cod_charge"
                                                            wire:model.live.debounce.250ms="cod_charge"
                                                            wire:change="changed" class="form-control" id="cod-charge"
                                                            value="{{ old('cod_charge', $cod_charge) }}"
                                                            {{ $a_only }}>
                                                ...
                                                <div class="col-md-4">
                                                    <div
                                                        class="form-group {{ $errors->has('payable') ? 'has-error' : '' }}">
                                                        <label for="payable">
                                                            Payable
                                                        </label>

                                                        <input type="text" name="payable" class="form-control"
                                                            id="payable" value="{{ old('payable', $payable) }}"
                                                            readonly>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div
                                                            ...
                                                            <input type="text" name="profit" class="form-control"
                                                                id="profit" value="{{ old('profit', $profit) }}" readonly>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="loss"
                                                                class="form-control bg-danger" id="loss"
                                                                value="{{ old('loss', $loss) }}" readonly>
                                                        </div>
                                                    </div>
                                                @endunless
                                                <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                <div
                                                    class="form-group {{ $errors->has('delivery_method') ? 'has-error' : '' }}">
                                                    ...
                                                    @if (count($courier) == 1)
                                                        <input type="text" name="delivery_method" id="delivery_method"
                                                            class="form-control"
                                                            value="{{ old('delivery_method', reset($courier)) }}"
                                                            readonly>
                                                    @else
                                                ...
                                                <div class="col-md-12">
                                                    <div
                                                        ...
                                                        <input type="text" name="booking_number" class="form-control"
                                                            id="booking_number"
                                                            value="{{ old('booking_number', $booking_number) }}"
                                                ...
                                                <div class="col-md-12">
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            <select name="status" id="status" class="mr-1 form-control">
                                                                @foreach (config('order.statuses') as $status)
                                                                    <option value="{{ $status }}"
                                                                        @if ($status == strtoupper($order->status)) selected @endif
                                                                        class="text-uppercase">{{ $status }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    @elseif($order->status == 'PENDING')
                                                        <div class="d-flex justify-content-end">
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                formaction="{{ route('reseller.order.destroy', $order->id) }}"
                                                                class="ml-1 btn btn-danger">Cancel</button>
                                                        </div>
                                                    @endunless
                                                </div>
                                            @endunless
                                ...
                                <table class="table table-bordered table-stripped table-hover table-narrow">
                                    ...
                                    <tbody>
                                        @foreach ($order->data['products'] as $item)
                                            ...
                                            <tr>
                                                <td><a
                                                        href="{{ $is_reseller ? route('reseller.product.show', $item['slug']) : route('admin.products.show', $item['id']) }}">{{ $item['name'] ?? '-' }}</a>
                                                </td>
