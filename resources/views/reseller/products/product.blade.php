        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6 col-sm-7 col-xs-12">
                <div class="product-details">
                    ...
                    <form method="POST" action="{{ route('cart.add', $product->id) }}" class="clearfix d-flex flex-column" style="width: 240px;">
                        @csrf
                        <div class="quantity pull-left clearfix mb-2">
                            ...
                            <div class="input-group-quantity pull-left clearfix">
                                <input type="text" name="qty" value="1"
                                    class="input-number input-quantity pull-left ml-2" id="qty" min="1" max="{{ $product->stock }}" size="5">
