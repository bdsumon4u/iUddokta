...
<div>
    <div class="form-group charge-box @error('sell') mb-0 has-error @enderror">
        ...
        <input type="number" class="form-control" name="sell" value="{{ old('sell', $sell) }}" id="sell-price" onfocus="$(this).select();">
    </div>
...
<div>
    <div class="form-group charge-box @error('shipping') mb-0 has-error @enderror">
        ...
        <input type="number" class="form-control" name="shipping" value="{{ old('shipping', $shipping) }}" id="shipping-charge" onfocus="$(this).select();">
    </div>
...
<div>
    <div class="form-group charge-box @error('advanced') mb-0 has-error @enderror">
        ...
        <input type="number" class="form-control" name="advanced" value="{{ old('advanced', $advanced) }}" id="advanced" onfocus="$(this).select();">
    </div>
