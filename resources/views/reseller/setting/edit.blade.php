                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <ul class="nav nav-tabs list-group" role="tablist">
                                <li class="nav-item rounded-0"><a
                                        class="nav-link @if ($errors->has('name') || $errors->has('email') || $errors->has('phone') || $errors->has('photo')) text-danger @endif active"
                                        data-toggle="tab" href="#item-1">General</a></li>
                                <li class="nav-item rounded-0"><a
                                        class="nav-link @if ($errors->has('nid.front') || $errors->has('nid.back')) text-danger @endif"
                                        data-toggle="tab" href="#item-2">Documents</a></li>
                                <li class="nav-item rounded-0"><a
                                        class="nav-link @if ($errors->has('payment_method') || $errors->has('payment_number')) text-danger @endif"
                                        data-toggle="tab" href="#item-3">Transaction</a></li>
                                <li class="nav-item rounded-0"><a
                                        class="nav-link @if ($errors->has('password') || $errors->has('old_password') || $errors->has('password_confirmation')) text-danger @endif"
                                        data-toggle="tab" href="#item-4">Password</a></li>
                            </ul>
                        </div>
                                    ...
                                    <form id="setting-form" action="{{ route('reseller.setting.update') }}" method="post"
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <input type="hidden" name="verified_at"
                                                value="{{ old('verified_at', $user->verified_at ?? 0) }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="photo" class="d-block">Photo<span
                                                                            class="text-danger">*</span></label>
                                                                    @unless ($verified_at)
                                                                        <input type="file" name="photo"
                                                                            value="{{ old('photo', $photo) }}" id="photo"
                                                                            cols="30" rows="10"
                                                                            class="@error('photo') is-invalid @enderror">
                                                                    @endunless
                                                                    <img src="{{ asset($photo) }}" alt="Photo"
                                                                        style="@unless ($photo) display: none; @endunless width: 40mm; height: 50mm; margin-top: 2mm;">
                                            ...
                                            <div class="tab-pane" id="item-2" role="tabpanel">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="nid-front" class="d-block">NID Front<span
                                                                    class="text-danger">*</span></label>
                                                            @unless ($verified_at)
                                                                <input type="file" name="nid[front]"
                                                                    value="{{ old('nid.front', $nid_front) }}" id="nid-front"
                                                                    cols="30" rows="10"
                                                                    class="@error('nid.front') is-invalid @enderror">
                                                            @endunless
                                                            <img src="{{ asset($nid_front) }}" alt="Photo"
                                                                style="@unless ($nid_front) display: none; @endunless width: 8.5cm; height: 5.5cm; margin-top: 2mm;">
                                                            {!! $errors->first('nid.front', '<span class="invalid-feedback">:message</span>') !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="nid-back" class="d-block">NID Back<span
                                                                    class="text-danger">*</span></label>
                                                            @unless ($verified_at)
                                                                <input type="file" name="nid[back]"
                                                                    value="{{ old('nid.back', $nid_back) }}" id="nid-back"
                                                                    cols="30" rows="10"
                                                                    class="@error('nid.back') is-invalid @enderror">
                                                            @endunless
                                                            <img src="{{ asset($nid_back) }}" alt="Photo"
                                                                style="@unless ($nid_back) display: none; @endunless width: 8.5cm; height: 5.5cm; margin-top: 2mm;">
                                                                ...
                                                                <div class="pt-2 border row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select
                                                                                name="payment[{{ $loop->index }}][method]"
                                                                                class="form-control payment_method @error('payment.' . $loop->index . '.method') is-invalid @enderror">
                                                                                ...
                                                                                @foreach (config('transaction.ways') as $way)
                                                                                    <option value="{{ $way }}"
                                                                                        @if ($way == $old_method) selected @endif>
                                                                                        {{ $way }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 {{ $payment->method == 'Bank' ? '' : 'd-none' }}"
                                                                        method="bank">
                                                                        <div class="form-group">
                                                                            <label for="">Bank Name</label>
                                                                            <input type="text" title="Bank Name"
                                                                                name="payment[{{ $loop->index }}][bank_name]"
                                                                                placeholder="Bank Name*"
                                                                                value="{{ old('payment.' . $loop->index . '.bank_name', $payment->bank_name ?? '') }}"
                                                                                class="bank_name form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 {{ $payment->method == 'Bank' ? '' : 'd-none' }}"
                                                                        method="bank">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" title="Account Name"
                                                                                name="payment[{{ $loop->index }}][account_name]"
                                                                                placeholder="Account Name*"
                                                                                value="{{ old('payment.' . $loop->index . '.account_name', $payment->account_name ?? '') }}"
                                                                                class="account_name form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 {{ $payment->method == 'Bank' ? '' : 'd-none' }}"
                                                                        method="bank">
                                                                        <div class="form-group">
                                                                            <label for="">Branch</label>
                                                                            <input type="text" title="Branch"
                                                                                name="payment[{{ $loop->index }}][branch]"
                                                                                placeholder="Branch"
                                                                                value="{{ old('payment.' . $loop->index . '.branch', $payment->branch ?? '') }}"
                                                                                class="branch form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 {{ $payment->method == 'Bank' ? '' : 'd-none' }}"
                                                                        method="bank">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" title="Routing No"
                                                                                name="payment[{{ $loop->index }}][routing_no]"
                                                                                placeholder="Routing No*"
                                                                                value="{{ old('payment.' . $loop->index . '.routing_no', $payment->routing_no ?? '') }}"
                                                                                class="routing_no form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            <label for="">Account Type</label>
                                                                            <input type="text" title="Account Type"
                                                                                name="payment[{{ $loop->index }}][type]"
                                                                                placeholder="Account Type*"
                                                                                value="{{ old('payment.' . $loop->index . '.type', $payment->type) }}"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" title="Account Number"
                                                                                name="payment[{{ $loop->index }}][number]"
                                                                                placeholder="Account Number*"
                                                                                value="{{ old('payment.' . $loop->index . '.number', $payment->number) }}"
                                                                                class="form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    @if (count($reseller->payment ?? []) > 1)
                                                                        <div class="col-12">
                                                                            <button
                                                                                class="float-right form-group btn btn-danger remove-way">Remove</button>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            @empty
                                                                <div class="pt-2 border row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="">Method</label>
                                                                            <select name="payment[0][method]"
                                                                                class="form-control payment_method @error('payment.0.method') is-invalid @enderror">
                                                                                <option value="">Select Method*
                                                                                </option>
                                                                    ...
                                                                    <div class="col-md-4 d-none" method="bank">
                                                                        <div class="form-group">
                                                                            <label for="">Bank Name</label>
                                                                            <input type="text" title="Bank Name"
                                                                                name="payment[0][bank_name]"
                                                                                placeholder="Bank Name*"
                                                                                value="{{ old('payment.0.bank_name') }}"
                                                                                class="bank_name form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 d-none" method="bank">
                                                                        <div class="form-group">
                                                                            <label for="">Account Name</label>
                                                                            <input type="text" title="Account Name"
                                                                                name="payment[0][account_name]"
                                                                                placeholder="Account Name*"
                                                                                value="{{ old('payment.0.account_name') }}"
                                                                                class="account_name form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 d-none" method="bank">
                                                                        <div class="form-group">
                                                                            <label for="">Branch</label>
                                                                            <input type="text" title="Branch"
                                                                                name="payment[0][branch]"
                                                                                placeholder="Branch"
                                                                                value="{{ old('payment.0.branch') }}"
                                                                                class="branch form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 d-none" method="bank">
                                                                        <div class="form-group">
                                                                            <label for="">Routing No</label>
                                                                            <input type="text" title="Routing No"
                                                                                name="payment[0][routing_no]"
                                                                                placeholder="Routing No*"
                                                                                value="{{ old('payment.0.routing_no') }}"
                                                                                class="routing_no form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">Account Number</label>
                                                                            <input type="text" title="Account Number"
                                                                                name="payment[0][number]"
                                                                                placeholder="Account Number*"
                                                                                value="{{ old('payment.0.number') }}"
                                                                                class="form-control @error('payment_number') is-invalid @enderror">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="tab-pane" id="item-4" role="tabpanel">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="mb-0 form-group">
                                                            <button type="submit"
                                                                formaction="{{ route('reseller.password.update') }}"
