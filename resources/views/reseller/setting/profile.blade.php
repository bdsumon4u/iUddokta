                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nid-front" class="d-block">NID Front<span
                                            class="text-danger">*</span></label>
                                    @unless ($verified_at)
                                        <input type="file" name="nid[front]" value="{{ old('nid.front', $nid_front) }}"
                                            id="nid-front" cols="30" rows="10"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @unless ($verified_at)
                                        <input type="file" name="nid[back]" value="{{ old('nid.back', $nid_back) }}"
                                            id="nid-back" cols="30" rows="10"
