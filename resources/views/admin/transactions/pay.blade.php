                                ...
                                <tbody>
                                    ...
                                    @foreach ($resellers as $reseller)
                                        <tr data-row-id="{{ $reseller->id }}">
                                            ...
                                            <td><a class="btn btn-sm btn-block btn-primary"
                                                    href="{{ route('admin.transactions.pay-to-reseller', [$reseller->id, 'amount' => $reseller->payNow]) }}">Pay
                                                    {{ theMoney($reseller->payNow) }}</a></td>
                                        </tr>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('.card-header').append(
                '<span class="badge p-2 badge-info required-amount" style="font-size: 100%;">Required Amount: {{ theMoney($payNow) }}</span>'
            )
        })
