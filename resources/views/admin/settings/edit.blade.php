                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <ul class="nav nav-tabs list-group" role="tablist">
                            ...
                            <li class="nav-item rounded-0"><a class="nav-link" data-toggle="tab" href="#item-5">Branding</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="form_title[login]" value="{{ old('form_title.login', $form_title->login ?? 'Login') }}" id="login-form-title" class="form-control @error('form_title.login') is-invalid @enderror">
                                                        {!! $errors->first('form_title.login', '<span class="invalid-feedback">:message</span>') !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="registration-form-title">Registration Form Title</label>
                                                        <input type="text" name="form_title[registration]" value="{{ old('form_title.registration', $form_title->registration ?? 'Register') }}" id="registration-form-title" class="form-control @error('form_title.registration') is-invalid @enderror">
