    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="shadow-sm card rounded-0">
                <div class="card-header">Add New <strong>Product</strong></div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card rounded-0">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.images.store') }}" id="drop-imgs"
            ...
            $(document).on('click', '#select-images-modal .select-item', function(e) {
                ...
                if (btn.hasClass('single')) {
                    ...
                    if (jQuery.inArray(theID, IDs) != -1) {
                        ...
                        src = $(this).parents('tr').find('.img-preview').attr('src');
                        btn.after('<div class="previewer"><img src="' + src +
                            '" alt="Additional Image" id="additional_images-preview-' + theID +
                            '" class="img-thumbnail img-responsive" style="height: 150px; width: 150px;"><i data-remove="' +
                            theID + '" class="fa fa-close"></i></div>')
                        IDs.push(theID);
                    }
                    // console.log('IDs', IDs)
