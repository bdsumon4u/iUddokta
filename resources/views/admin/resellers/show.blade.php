            ...
            <div class="shadow-sm card rounded-0">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <img class="m-2" src="{{ asset(optional($reseller->documents)->photo) }}" alt="Photo"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="text-nowrap"><a
                                            href="{{ route('admin.order.index', ['status' => 'PENDING', 'reseller' => $reseller->id]) }}">Pending
                                            Orders</a>:</th>
                                    <td>{{ theMoney($reseller->pending_sell) }}</td>
                                </tr>
                                <tr>
                                    <th class="text-nowrap"><a
                                            href="{{ route('admin.order.index', ['status' => 'PROCESSING', 'reseller' => $reseller->id]) }}">Processing
                                            Orders</a>:</th>
                                    <td>{{ theMoney($reseller->processing_sell) }}</td>
                                </tr>
                                <tr>
                                    <th class="text-nowrap"><a
                                            href="{{ route('admin.order.index', ['status' => 'SHIPPING', 'reseller' => $reseller->id]) }}">Shipping
                                            Orders</a>:</th>
                                    <td>{{ theMoney($reseller->shipping_sell) }}</td>
                                </tr>
                                <tr>
                                    <th class="text-nowrap"><a
                                            href="{{ route('admin.order.index', ['status' => 'DELIVERED', 'reseller' => $reseller->id]) }}">Completed
                                            Orders</a>:</th>
                                    <td>{{ theMoney($reseller->completed_sell) }}</td>
                                </tr>
                                <tr>
                                    <th class="text-nowrap"><a
                                            href="{{ route('admin.order.index', ['status' => 'FAILED', 'reseller' => $reseller->id]) }}">Returned
                                            Orders</a>:</th>
                                    <td>{{ theMoney($reseller->returned_sell) }}</td>
                                </tr>
                                <tr>
                                    <th><a
                                            href="{{ route('admin.transactions.index', ['status' => 'paid', 'reseller' => $reseller->id]) }}">Total
                                            Paid</a>:</th>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex" style="flex-wrap: wrap-reverse;">
                                        @foreach ((new App\Services\EarningService($reseller))->periods as $period)
                                            <a class="p-2 m-1 badge badge-primary"
                                                href="{{ route('earnings', ['reseller_id' => $reseller, 'period' => $period]) }}">{{ $period }}</a>
                                        @endforeach
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="mt-3 row">
                        <div class="col-12">
                            <h4 class="text-center">NID Photo</h4>
                        </div>
                        <div class="border col-md-6">
                            <img class="m-2" src="{{ asset(optional($reseller->documents)->nid_front) }}"
                                alt="NID Front" style="height: 100%; max-height: 5.5cm; width: 100%; max-width: 8.5cm;">
                        </div>
                        <div class="border col-md-6">
                            <img class="m-2" src="{{ asset(optional($reseller->documents)->nid_back) }}" alt="NID Back"
                                style="height: 100%; max-height: 5.5cm; width: 100%; max-width: 8.5cm;">
                        </div>
                    </div>
                    <hr>
