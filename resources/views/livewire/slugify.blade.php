<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <input type="text" name="{{ $src['name'] }}" wire:model.live.debounce.250ms="title" wire:keyup="slugify" value="{{ old($src['name'], $title) }}" id="{{ $src['id'] }}" class="form-control @error($src['name']) is-invalid @enderror">
