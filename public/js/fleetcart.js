...
__webpack_require__(/*! jquery-slimscroll */ "./node_modules/jquery-slimscroll/jquery.slimscroll.js"); // require('flatpickr');
...
function stopButtonLoading(button) {
  ...
  button.data('loading-text', button.html()).removeClass('btn-loading');
}
...
$(function () {
  ...
  var directionClass = isRTL ? 'rtl' : 'ltr';
  /*----------------------------------------*/
  ...
  $('#search-box-form').on('submit', function (e) {
    e.preventDefault();
    var searchBoxInputs = $('.search-box-input');
    searchBoxInputs.each(function (i, el) {
      if (el.value === '') {
  ...
  $('.select').each(function () {
    ...
    self.on('change', function () {
      var selectOption = self.find('option:selected').text();
      var tempSelect = $('<span>').html(selectOption);
      tempSelect.appendTo('body');
      var selectOptionWidth = tempSelect.width();
      tempSelect.remove();
  ...
  $(document).on('click', '[data-loading]', function (e) {
    ...
    button.data('loading-text', button.html()).addClass('btn-loading');
  });
  /*----------------------------------------*/
  ...
  $('.btn-cookie').on('click', function () {
    $.post(route('cookie_bar.accepted'), function () {
      var cookieBarWrapper = $('.cookie-bar-wrapper');
      cookieBarWrapper.fadeOut(300, function () {
        return cookieBarWrapper.remove();
      });
    });
  });
  /*----------------------------------------*/
  ...
  var dropdown = $('.sidebar-content li.parent > a');
  dropdown.after('<i class="fa fa-angle-down pull-right" aria-hidden="true"></i>');
  var sidebarContent = $('.sidebar-content > li');
  ...
  var miniCartVariants = $('.mini-cart-variants');
  userCart.on('mouseleave', function () {
    $('.mini-cart-variants').removeClass('open');
  });
  miniCartVariants.on('click', function (e) {
    var target = $(e.currentTarget);
  ...
  $('.home-slider').on('init', function () {
    var firstAnimatingElements = $('div.slide:first-child').find('[data-effect]');
    animateSlider(firstAnimatingElements);
  });
  $('.home-slider').on('beforeChange', function (e, slick, currentSlide, nextSlide) {
    var animatingElements = $("div.slick-slide[data-slick-index=".concat(nextSlide, "]")).find('[data-effect]');
  ...
  function animateSlider(elements) {
    ...
    elements.each(function () {
      ...
      var animationEffect = "animated ".concat(element.data('effect'));
      element.css({
        'animation-delay': animationDelay,
        '-webkit-animation-delay': animationDelay
      });
      element.addClass(animationEffect).one(animationEndEvents, function () {
  ...
  var tabProductSlider = $('.tab-product-slider');
  ...
  var verticalProducts = $('.vertical-products');
  ...
  function productImage() {
    var baseImageConfig = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var additionalImageConfig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var baseImage = $('.base-image');
    var additionalImage = $('.additional-image');
    ...
    }, additionalImageConfig)); // $('.base-image-inner img').each((i, img) => {
    //     new Drift(img, {
    //         sourceAttribute: 'src',
  ...
  function selectize() {
    var selects = $('select.selectize').removeClass('custom-select-black');
  ...
  $('.filter-category li').each(function (i, li) {
    if ($(li).children('ul').length > 0) {
      $(li).addClass('parent');
    }
  });
  var categoryDropdown = $('.filter-category li.parent > a');
  categoryDropdown.before('<i class="fa fa-angle-right pull-left" aria-hidden="true"></i>');
  var parentUls = $('.filter-category li.active').parentsUntil('.filter-category', 'ul');
  parentUls.slideDown().addClass('open');
  $('.filter-category ul.open').siblings('i').addClass('open');
  $('.filter-category li i').on('click', function (e) {
  ...
  $('.next-step').on('click', function (e) {
    var li = $('.wizard .nav-tabs li.active');
  ...
  $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
    ...
    var percent = parseInt(step - 1) / 3 * 150;
    $('.progress-bar').css({
      width: percent + '%'
    });
  });
...
/***/ 3:
/*!*****************************************!*\
  !*** multi ./resources/js/fleetcart.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/resources/js/fleetcart.js */"./resources/js/fleetcart.js");
